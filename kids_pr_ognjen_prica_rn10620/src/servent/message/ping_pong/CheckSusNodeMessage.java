...
public class CheckSusNodeMessage extends BasicMessage {
    @Serial
    ...
    public CheckSusNodeMessage(String senderIpAddress, int senderPort, String receiverIpAddress, int receiverPort, String susIp, int susPort) {
